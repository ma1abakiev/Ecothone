...
export default function Header() {
  ...
  //       `http://localhost:8000/api/store/search?query=${searchText}`
  //     )
      ...
      >
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex', gap: '30px  ' } }}>
            ...
            >
              <Link to={'/cart'}>
                <StyledBadge color="secondary" badgeContent={totalItemsCount}>
                  <ShoppingCartIcon color="action" />
                </StyledBadge>
              </Link>
            </IconButton>
            <Link to={'http://localhost:8000/admin/store/product/'}>
              <IconButton
                size="large"
                edge="end"
                aria-label="account of current user"
