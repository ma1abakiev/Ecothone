    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Клиент'), ('organization', 'Организация')], max_length=100)),
                ('organization_name', models.CharField(blank=True, max_length=255, unique=True)),
                ('organization_phone_number', models.CharField(blank=True, max_length=100)),
            ],
            options={
                'verbose_name': 'user',
